...
import com.pcm.psoft.pcmclinic_api.usermanagement.dto.input.UpdatePhysicianRequest;
import com.pcm.psoft.pcmclinic_api.usermanagement.dto.output.PhysicianIdResponse;
import com.pcm.psoft.pcmclinic_api.usermanagement.api.PhysicianMapper;
...
import com.pcm.psoft.pcmclinic_api.usermanagement.model.*;
...
import com.pcm.psoft.pcmclinic_api.appointment.dto.output.TopPhysicianDTO;
...
public class PhysicianService {
    ...
    @Transactional(readOnly = true)
    public List<TopPhysicianDTO> getTop5Physicians(java.time.LocalDateTime from, java.time.LocalDateTime to) {
